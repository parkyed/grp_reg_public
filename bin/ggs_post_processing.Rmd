...
# load stability measurement results (independent of the validation set, since using all genes)
...
loadAUCFunc <- function(x){
  loadRData(here("output", "smith", "wynn", paste("fwelnet.res", test.n.features, pway, "0.95", x, "RData", sep="."))) %>% 
    .$test.scores %>% 
    .["auc",]
}
...
# calculate the number of genes selected by module
...
# join selected genes and pathways with differential expression results for the training dataset
