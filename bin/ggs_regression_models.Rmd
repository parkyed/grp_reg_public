...
# source(here("scr", "downSampleTest.R"))
...
vset <- "protect"  # "wynn" "protect" "cernada"
...
# 
# if (vset == "wynn"){
#   t.data.path.scaled   <- "/Users/ep/Documents/1_datasets/dataset_wynn/output/wynn.exp.mat.filtered.scaled.los.csv"
#   # t.samp.info.path     <- "/Users/ep/Documents/1_datasets/dataset_wynn/output/sample.info.los.csv"
#   t.label.path         <- "/Users/ep/Documents/1_datasets/dataset_wynn/output/y.true.los.csv"
# } else if (vset == "cernada"){
#   t.data.path.scaled   <- "/Users/ep/Documents/1_datasets/dataset_cernada/output/exp.mat.filtered.scaled.csv"
#   # t.samp.info.path     <- "/Users/ep/Documents/1_datasets/dataset_cernada/output/sample.info.csv"
#   t.label.path         <- "/Users/ep/Documents/1_datasets/dataset_cernada/output/y.true.csv"
# } else if (vset == "protect"){
#   t.data.path.scaled   <- "/Users/ep/Documents/1_datasets/dataset_pearth/an0304/output/grp_reg_outputs/vst.mat.filtered.scaled.csv"
#   # t.samp.info.path     <- "/Users/ep/Documents/1_datasets/dataset_pearth/an0304/output/grp_reg_outputs/sample.info.csv"
#   t.label.path         <- "/Users/ep/Documents/1_datasets/dataset_pearth/an0304/output/grp_reg_outputs/y.true.csv"
# }
...
# samp.info.test <- read.table(file = t.samp.info.path, header = T, sep = ',')
# table(samp.info$condition)
# table(samp.info.test$condition)
...
## testing - extracting the selected features at each fold to illustrate the stability

=== is this for deletion?? ====

```{r}

# to get the mean number of features selected across all folds for a specific lambda value

# use the feature.tib.all object - has the set of features selected for every lambda at every fold
# count the number of features - number of values in each cell
# 
# n.feat.lst <- map(.x = feature.tib,
#     .f = function(x){lapply(x$sel.features, length)})
# 
# n.feat.df <- as.data.frame(do.call(cbind, lapply(n.feat.lst, as.numeric)))
# 
# mean.f.by.lambda <- data.frame(lambda = lambda.path,
#                                mean.f = rowMeans(n.feat.df))

# to get the groups selected at each lambda at each fold
...
theta.range <- c(2.5)
# (theta.range <- seq(0.25, 3.75, 0.25)) # for full grid search - change the file saved to below
